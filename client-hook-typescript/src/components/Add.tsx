    ...
    return (
        <div>
            ...
            <form onSubmit={handleAdd}>
                ...
                <input type="text" placeholder="Director" value={director} onChange={(e) => setDirector(e.currentTarget.value)}/>
                <input type="text" placeholder="Rating" value={rating} onChange={(e) => setRating(e.currentTarget.value)}/>
